...
const GraceAI: React.FC = () => {
  ...
  const handleAsk = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const result = await askGraceAI(question, "Grace Community Church system. Managers: David Chen, Sarah Michaels, Yuki.", language);
    setResponse(result);
    setHistory(prev => [{ q: question, a: result }, ...prev]);
    setLoading(false);
    setQuestion('');
  };
            ...
            {history.map((item, i) => (
              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  <div className="bg-white px-6 py-4 rounded-3xl rounded-tl-none border border-primary/10 shadow-sm max-w-[85%]">
